...
<div class="container mx-auto px-4 py-8">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('jadwal.create') }}" class="bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 transition">
            ...
            <table class="min-w-full divide-y divide-gray-200">
                ...
                <tbody class="bg-white divide-y divide-gray-200">
                    ...
                    <tr class="hover:bg-gray-50">
                        ...
                        <td class="px-6 py-4 whitespace-nowrap">{{ $item->guru->nama ?? '-' }}</td>
                        <td class="px-6 py-4 whitespace-nowrap">
                            <div class="font-mono text-sm">
                                {{ $item->jam_mulai }} - {{ $item->jam_selesai }}
                            </div>
                        </td>
                        <td class="px-6 py-4 whitespace-nowrap">{{ $item->ruangan }}</td>
                        <td class="px-6 py-4 whitespace-nowrap text-sm font-medium">
                            <div class="flex space-x-2">
                                <a href="{{ route('jadwal.show', $item->id) }}" class="text-blue-600 hover:text-blue-900">
                                    <i class="fas fa-eye"></i>
                                </a>
                                <a href="{{ route('jadwal.edit', $item->id) }}" class="text-yellow-600 hover:text-yellow-900">
